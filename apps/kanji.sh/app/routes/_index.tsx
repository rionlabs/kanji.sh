...
import { Direction, ServiceCard } from '@kanji-sh/app/components';
    ...
    <div>
      <div className='flex flex-col sm:flex-row sm:items-center'>
        ...
        <div className='w-full'>
          ...
          <div>
            <svg id='homepage-anim' viewBox='0 0 400 300' xmlns='http://www.w3.org/2000/svg'
                 style={{ border: '1px solid #ccc' }}>
              {/* Background notebook */}
              <rect x='50' y='50' width='300' height='200' rx='15' ry='15' fill='#f4f4f4' stroke='#000'
                    stroke-width='2' />
              <line x1='150' y1='50' x2='150' y2='250' stroke='#000' stroke-width='2' />
              {/* Pages */}
              <g id='pages'>
                <rect x='150' y='50' width='150' height='200' rx='10' ry='10' fill='white' stroke='#ddd'
                      stroke-width='1' />
                <text x='225' y='150' font-size='48' text-anchor='middle' dominant-baseline='middle'
                      font-family='Arial'>
                  田
                </text>
              </g>
