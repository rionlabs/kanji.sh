...
module.exports = {
    displayName: 'printer-cli',
    preset: '../../jest.preset.js',
    moduleNameMapper: {
        '^@kanji-sh/models$': '<rootDir>/../models/src/index.ts',
        '^@kanji-sh/printer$': '<rootDir>/../printer/src/index.ts'
    },
    transform: {
    ...
    coverageDirectory: '../../coverage/libs/printer-cli'
};
