    ...
    return (
        <Page>
            ...
            <Typography variant={"body1"} gutterBottom>
                ...
                kanji.sh unless otherwise defined in this Privacy Policy.
            </Typography>
            ...
            <Typography variant={"h5"} gutterBottom>Cookies</Typography> <Typography
            variant={"body1"}>
            ...
            <Typography variant={"body1"} gutterBottom>This policy is effective as of 2020-10-01.</Typography>
