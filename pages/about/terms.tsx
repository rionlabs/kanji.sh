    ...
    return (
        <PageLayout>
            ...
            <Typography variant={'body1'} gutterBottom>
                By using the web app (referred as 'app' from here), these terms will automatically
                apply to you – you should make sure therefore that you read them carefully before
                using the app. The app itself, and all the trade marks, copyright, database rights
                and other intellectual property rights related to it, still belong to{' '}
                {Config.maintainer}.
            </Typography>
            <Typography variant={'body1'} gutterBottom>
                {Config.maintainer} is committed to ensuring that the app is as useful and efficient
            ...
            <Typography variant={'body1'} gutterBottom>
                You should be aware that there are certain things that {Config.maintainer} will not
                take responsibility for. Certain functions of the app will require the app to have
                an active internet connection. The connection can be Wi-Fi, or provided by your
                mobile network provider, but {Config.maintainer}
                cannot take responsibility for the app not working at full functionality if you
            ...
            <Typography variant={'body1'} gutterBottom>
                Along the same lines, {Config.maintainer} cannot always take responsibility for the
                way you use the app i.e. You need to make sure that your device stays charged – if
            ...
            <Typography variant={'body1'} gutterBottom>
                ...
                {Config.maintainer} accepts no liability for any loss, direct or indirect, you
            ...
            <Typography variant={'body1'} gutterBottom>
                ...
                platform – the requirements for both systems(and for any additional systems we
                decide to extend the availability of the app to) may change, and you’ll need to
                download the updates if you want to keep using the app. {Config.maintainer} does not
                promise that it will always update the app so that it is relevant to you and/or
                works with the browser version that you have installed on your device. However, you
                promise to always accept updates to the application when offered to you, We may also
                ...
                termination, (a) the rights and licenses granted to you in these terms will end; (b)
