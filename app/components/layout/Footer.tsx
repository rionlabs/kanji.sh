            ...
            <div className='container text-white text-opacity-90'>
                <div className='flex flex-col sm:flex-row gap-4 justify-evenly py-12'>
                    <div className='w-full sm:w-auto flex flex-col gap-2'>
                        <a className="link link-hover after:content-['_↗']" href={Config.githubUrl} target='_blank' rel="noreferrer">GitHub</a>
                        <a className="link link-hover after:content-['_↗']" href={Config.bmcUrl} target='_blank' rel="noreferrer">Buy a Sushi</a>
                    </div>
                    ...
                    <div className='w-full sm:w-auto flex flex-col gap-2'>
                        ...
                        <Link className="link link-hover" to={'/about/acknowledgments'} prefetch='intent'>
                            Acknowledgments
                        </Link>
                        <Link className="link link-hover" to={'/about/privacy-policy'} prefetch='intent'>
                            Privacy Policy
                        </Link>
