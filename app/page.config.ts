export const PageConfig: Record<string, { priority: number, title: string, description: string }> = {
    '/': {
        ...
        'description': 'Practice the Kanjis you learned over the years with distraction-free sheets.'
    },
    '/read': {
        'priority': 0.8,
    ...
    '/about/terms': {
        'priority': 0.5,
        'title': 'Terms of Use',
        'description': 'Kanji.sh is a free and open-source collection of worksheets for practicing Japanese Kanji. '
    },
